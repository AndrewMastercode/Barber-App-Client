  ...
  handleSubmit = async (e) => {
    ...
    await axios
      ...
      .then((res) => {
        ...
        alert("Service Added with Success...");
            ...
            <div class="col-md-6">
              <div class="card">
                <form class="box" onSubmit={this.handleSubmit}>
                  ...
                  <br />
                  <h3 className="text-light">"Give some information about you want to do!"</h3>
                  <input
                    type="text"
                  ...
                  />
                  <input type="submit" name="" value="Book" href="/shedulelist" />
                </form>
              </div>
            </div>
          </div>
